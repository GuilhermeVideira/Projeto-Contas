...
{
    partial class frmRelatorioContaAReceber
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Value = this.tb_contaAReceberBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "ProjetoConta.RelatorioContaAReceber.rdlc";
            ...
            this.Name = "frmRelatorioContaAReceber";
            this.Text = "Relatório Conta A Receber";
            this.Load += new System.EventHandler(this.FrmRelatorioContaAReceber_Load);
